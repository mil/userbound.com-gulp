      ...
      return gulp
        ...
        .pipe($.data(function(page_object) {
          ...
          if (collection_name === "interfaces") {
            ...
            x.print = page_object.vars.categories.print;
            x.mixtapes = page_object.vars.categories.mixtapes;
          }
        ...
        .pipe(gulp.dest(collection_name === "interfaces" ? util.fs_out() : util.fs_out(collection_name)));
      });
