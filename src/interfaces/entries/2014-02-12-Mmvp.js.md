...
The above example<sup>2</sup> shows binding of the `add` action callback. In addition to `add` callback, the following callbacks may be bound to react to model changes:
